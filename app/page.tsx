    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-6 z-10 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a href="#portfolio" className="bg-white text-indigo-900 px-8 py-3 rounded-lg text-lg font-semibold hover:bg-blue-50 transition-colors shadow-lg">
                Our Portfolio
              </a>
              <a href="https://linkedin.com/in/davidroberteagan" target="_blank" rel="noopener noreferrer" className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-white/10 transition-colors">
                Connect on LinkedIn
              </a>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-12 mb-16">
            ...
            <div className="md:w-1/2">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-indigo-600 p-6 rounded-lg text-white h-48 flex flex-col justify-center transform hover:scale-105 transition-transform">
                  <h3 className="text-xl font-bold mb-2">Innovation</h3>
                  <p>We seek out groundbreaking ideas that challenge the status quo and create new possibilities.</p>
                </div>
                <div className="bg-blue-500 p-6 rounded-lg text-white h-48 flex flex-col justify-center transform hover:scale-105 transition-transform mt-8">
                  <h3 className="text-xl font-bold mb-2">Partnership</h3>
                  <p>We build lasting relationships with founders based on trust, support, and shared vision.</p>
                </div>
                <div className="bg-purple-500 p-6 rounded-lg text-white h-48 flex flex-col justify-center transform hover:scale-105 transition-transform">
                  <h3 className="text-xl font-bold mb-2">Growth</h3>
                  <p>We&apos;re committed to helping our portfolio companies scale and achieve their full potential.</p>
                </div>
                <div className="bg-indigo-800 p-6 rounded-lg text-white h-48 flex flex-col justify-center transform hover:scale-105 transition-transform mt-8">
                  <h3 className="text-xl font-bold mb-2">Impact</h3>
                  <p>We invest in technologies that solve meaningful problems and create lasting value.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-10 mt-16">
            <div className="flex items-center">
              <div className="text-5xl font-bold text-indigo-600 mr-4">25+</div>
              <div className="text-gray-700">Companies<br/>Invested</div>
            </div>
            <div className="flex items-center">
              <div className="text-5xl font-bold text-indigo-600 mr-4">6</div>
              <div className="text-gray-700">Investment<br/>Categories</div>
            </div>
            <div className="flex items-center">
              <div className="text-5xl font-bold text-indigo-600 mr-4">5+</div>
              <div className="text-gray-700">Years of<br/>Experience</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="portfolio" className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-16 text-gray-900">Our Portfolio</h2>
          
          {investmentThemes.map((theme) => (
            <div key={theme} className="mb-20">
              <h3 className="text-3xl font-bold mb-12 text-gray-900 border-b pb-4">
                {theme}
              </h3>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-4 text-gray-900">Vibe Coding</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold mb-2">MoonTower Business</h3>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold mb-2">Dinestein</h3>
                <p className="text-gray-600 mb-4">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold mb-2">GoVisitWinery</h3>
                <p className="text-gray-600 mb-4">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold mb-2">OptimizeBnb.ai</h3>
                <p className="text-gray-600 mb-4">
      ...
      <section id="contact" className="py-20 bg-gray-900 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center bg-indigo-600 text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-indigo-700 transition-colors"
          >
      ...
      {/* Legal Disclaimer */}
      <section className="py-8 bg-gray-950 text-gray-400">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-xs leading-relaxed">
            <h3 className="text-sm font-semibold mb-3 text-gray-300">Legal Disclaimer</h3>
            <p className="mb-2">
